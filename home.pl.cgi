...
sub loggedIn{
	...
	print "<center><form action=\"makeReservation.pl.cgi\" method=POST>";
	print "<input type=\"hidden\" value=$user name=\"user\">";
	print "<input type=\"submit\" name=\"res\" value=\"Make Reservation\"></form>";
	print "<form action=\"cancelReservation.pl.cgi\" method=POST>";
	print "<input type=\"hidden\" value=$user name=\"user\">";
	print "<input type=\"submit\" name=\"cancel\" value=\"See/Cancel Reservation\"></form>";
	print "<form action=\"home.pl.cgi\" method=GET>";
	print "<input type=\"hidden\" value=$user name=\"user\">";
	print "<input type=\"submit\" name=\"act\" value=\"See Activity\"></form>";
	print "<form action=\"resetPassword.pl.cgi\" method=POST>";
	print "<input type=\"hidden\" value=$user name=\"user\">";
	print "<input type=\"submit\" name=\"changepass\" value=\"Change Password\"></form></center>";
}

sub admin{
	print "<center>WELCOME ADMIN<br><br><form action=\"home.pl.cgi\" method=GET>";
	print "<input type=\"hidden\" value=$user name=\"user\">";
	print "<input type=\"submit\" name=\"adminact\" value=\"See Activity\"></form>";
	print "<form action=\"resetPassword.pl.cgi\" method=POST>";
	print "<input type=\"hidden\" value=$user name=\"user\">";
	print "<input type=\"submit\" name=\"changepass\" value=\"Change Password\"></form></center>";
}
...
sub printActivity{
	...
	print "<center>Here is a log of everything that has happened on the site:<br><br>";
	foreach(@file){
		print "$_<br>";
	}

	print "<br><form name=\"MyForm\" method=GET action=\"home.pl.cgi\">";
	print "<input type=\"hidden\" name=\"user\" value=\"$user\">";
	print "<input type=\"hidden\" name=\"user\" value=\"$user\">";
	print "<input type=\"submit\" value=\"Home\"></form>";
	print "</center>";
